...
function inherit(child, parent) {
    ...
    child.super = function (ths, method) {
        // TODO this is probably real slow
        if (method) {
            parent.prototype[method].apply(ths, Array.prototype.slice.call(arguments, 2));
        } else {
            parent.apply(ths, Array.prototype.slice.call(arguments, 2));
        }
    };
}
...
(function () {
    ...
    var base = window.objects.base = function (name) {
        this.name = name;
    };
    ...
    base.prototype.hits = function (ex, ey) {
       return false;
    };
    
    base.prototype.contains = function (x, y) {
       return false;
    };
})();
(function () {
...
var graphic = window.objects.graphic = function (name, pos, angle, sprite_str) {
    graphic.super(this, null, name);
    this.graphic = new graphics.sprite(sprite_str);
    this.x = pos[0];
    this.y = pos[1];
    this.angle = 0;
};
inherit(graphic, window.objects.base);
...
graphic.prototype.hits = function (ex, ey) {
   return this.contains(ex, ey);
};

graphic.prototype.contains = function (x, y) {
...
var background = window.objects.background = function (pos, name, solid, sprite_str) {
    background.super(this, null, name, pos, 0, sprite_str);
    this.solid = solid;
};
inherit(background, window.objects.graphic);
...
(function () {
    // Fixed game object with a description
    var fixed = window.objects.fixed = function (pos, name, sprite_str, desc) {
        fixed.super(this, null, name, pos, 0, sprite_str);
        this.description = desc;
    };
    inherit(fixed, window.objects.graphic);
